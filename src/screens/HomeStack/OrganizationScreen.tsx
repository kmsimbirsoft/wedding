    ...
    <ScrollView>
        ...
        <View style={{marginTop: 10}}>
          ...
          <View>
            <View
              ...
              <View style={styles.category}>
                <Text style={styles.categoryTextPrice}>Прайс</Text>
              </View>
            </View>
            {organization?.service?.map((item: any, index: number) => (
              <View
                ...
                <View style={styles.category}>
                  <Text style={styles.categoryTableText}>{item.category}</Text>
                </View>
                <View style={styles.category}>
                  <Text style={styles.categoryTableTextPrice}>
                    {item.price} ₽
                  </Text>
                </View>
              </View>
          ...
          <Text style={[styles.categoryText, {marginTop: 15}]}>
            Мы в соцсетях
          </Text>
          <View
            style={{
      ...
      <View>
        <Text
          style={[
            styles.categoryText,
            {paddingBottom: 10, paddingHorizontal: 15, marginTop: 15},
          ]}>
          Галлерея
        </Text>
