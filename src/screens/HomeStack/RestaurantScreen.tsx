...
const RestaurantScreen = observer(() => {
  ...
  useEffect(() => {
    getRestaurantOrganizations(userStore.userInfo?.personal?.city || '');
  }, []);
    ...
    <ScrollView style={styles.mainContainer}>
      ...
      {organizationList.length < 1 && (
        <Text style={styles.noOrg}>
          К сожалению ресторанов по вашему городу еще нет... {'\n'}
