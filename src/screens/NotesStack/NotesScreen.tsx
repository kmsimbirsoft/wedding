  ...
  return (
    <ScrollView style={styles.mainContainer}>
      <View style={{marginTop: 20}}>
        ...
        <View>
          <TouchableOpacity
            onPress={() => NavigationService.navigate('WeddingDateScreen')}
            style={[styles.notesItem, {marginTop: 0}]}>
            <IconRings />
            <Text style={styles.text}>Дата свадьбы</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => NavigationService.navigate('UserNotesScreen')}
            style={styles.notesItem}>
            <IconNotes />
            <Text style={styles.text}>Заметки</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => NavigationService.navigate('UserGuestScreen')}
            style={styles.notesItem}>
            <IconGuest />
            <Text style={styles.text}>Наши гости</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => NavigationService.navigate('UserFavoriteScreen')}
            style={styles.notesItem}>
            <IconHeart />
