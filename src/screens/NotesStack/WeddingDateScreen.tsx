        ...
        {userInfo?.personal?.weddingDate ? (
          <View>
            <Text style={styles.dateText}>
              {moment(userInfo?.personal?.weddingDate)
                .toISOString()
                .substring(0, 10)}
            </Text>
            ...
            <View style={{marginTop: 10}}>
              <Text style={[styles.dateTextBottom, {color: '#59d094'}]}>
                Осталось дней {Math.floor(timeTotal / 86400)}
              </Text>
              <Text style={[styles.dateTextBottom, {color: '#46aaee'}]}>
                Осталось часов {Math.floor(timeTotal / 3600)}
              </Text>
              <Text style={[styles.dateTextBottom, {color: '#f66d6d'}]}>
                Осталось минут {Math.floor(timeTotal / 60)}
              </Text>
              <Text style={[styles.dateTextBottom, {color: '#ea6df8'}]}>
                Осталось секунд {timeTotal}
              </Text>
            </View>
            <View style={styles.bottom}>
              <TouchableOpacity onPress={onSelectDate} style={styles.btn}>
                <Text style={styles.btnText}>Установить другую дату</Text>
              </TouchableOpacity>
            </View>
          </View>
        ) : (
